...
export default new Router({
  ...
  routes: [
    ...
    {path:'/blog:blogId',name:'BlogDetail',component:resolve => require(["../components/BlogDetail"],resolve)},
    {path:'/Edit:blogId',name:'BlogEdit',component:resolve => require(["../components/BlogEdit"],resolve), meta: {requireAuth: true}},
    {path:'/Id',name:'BlogsId',component:resolve => require(["../components/BlogsId"],resolve), meta: {requireAuth: true}},
    ...
    {path:'/userPassword',name:'UserPassword',component:resolve => require(["../components/UserPassword"],resolve)},
